class Constants(object):
    ...
    REDIS_KEY_ALL_COIN_MARKET_BUY_PREFIX = 'allCoinMarketBuy'
    REDIS_KEY_ALL_COIN_MARKET_SELL_PREFIX = 'allCoinMarketSell'
    REDIS_KEY_BIT_Z_MARKET_BUY_PREFIX = 'bitZMarketBuy'
    REDIS_KEY_BIT_Z_MARKET_SELL_PREFIX = 'bitZMarketSell'
